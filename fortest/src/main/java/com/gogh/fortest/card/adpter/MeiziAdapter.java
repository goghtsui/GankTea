package com.gogh.fortest.card.adpter;
...
import com.gogh.fortest.card.common.RoundTransform;
...
public class MeiziAdapter extends BaseCardAdapter {
    ...
    public void onBindData(int position, @NonNull View cardview) {
        ...
        Picasso.with(context).load(meizi.getImageurl()).config(Bitmap.Config.ARGB_8888).transform(new RoundTransform()).into(imageView);
    }
