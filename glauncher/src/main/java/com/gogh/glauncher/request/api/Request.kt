...
internal interface Request {
    fun getDayWeather(lat : String, lon : String, onResponseListener: OnResponseListener<DayBean>)

    fun getDailyWeather(lat : String, lon : String, onResponseListener: OnResponseListener<DailyBean>)
}